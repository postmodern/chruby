...
## Install
    ...
    wget -O chruby-0.2.4.tar.gz https://github.com/postmodern/chruby/archive/v0.2.4.tar.gz
    tar -xzvf chruby-0.2.4.tar.gz
    cd chruby-0.2.4/
    make install
...
with:
    ...
    wget https://raw.github.com/postmodern/chruby/master/pkg/chruby-0.2.4.tar.gz.asc
    gpg --verify chruby-0.2.4.tar.gz.asc chruby-0.2.4.tar.gz
